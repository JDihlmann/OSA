...
class Network:
    ...
    def __init__(self, image_dataset=None, position_dataset=None, image_input_shape=(512, 512, 3), position_input_shape=(256+3)):
        ...
        self.checkpoint_dir_fNetwork = str(Path(__file__).parent.parent.absolute())  + "/" +  self.checkpoint_path_fNetwork
        self.checkpoint_path_gNetwork = "models/g/cp-{epoch:04d}.ckpt"
        self.checkpoint_dir_gNetwork = str(Path(__file__).parent.parent.absolute())  + "/" +  self.checkpoint_path_gNetwork
